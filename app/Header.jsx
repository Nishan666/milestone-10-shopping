...
const Header = () => {
  ...
  return (
    <div className="navbar bg-base-100 border-b-2 shadow-md py-2 px-4">
      ...
      <div className="navbar-end gap-3">
        ...
        <label className="swap swap-rotate">
          ...
          />
          <svg
            className="swap-on fill-current w-10 h-10 border-2 p-2 shadow-sm"
          ...
          <svg
            className="swap-off fill-current w-10 h-10 border-2 p-2 shadow-sm"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
